...
# ── Confirm return received from driver ──────────────────────────────────────
...
async def receive_return(
    ...
    # Add return fee to seller ledger
    if pkg.seller_id:
        return_fee = 200.0
...
async def payout_seller(
    ...
    note = body.get("note", "Paiement vendeur")
